                ...
                ?>
                  <div class="card materi-card">
                      ...
                      <div class="card-body">
                          ...
                          <a href="<?= base_url() ?>main/downloadfile/<?= $ukm->id ?>/<?= $m->id ?>"><button class="btn">Download</button></a>
                      </div>
                  </div>
              <?php } ?>
          </div>
  ...
  <section id="dokumentasi-ukm">
      <div class="container">
          <div class="row mb-5">
              <div class="col-md-6 dokum-ukm">
                  <img src="dokumentasi/dok-neo1.png" class="img-fluid rounded" alt="Dokumentasi UKM" />
                  <br />
                  <hr />
                  <img src="dokumentasi/dok-neo2.png" class="img-fluid rounded img-dokum" alt="Dokumentasi UKM" />
                  <img src="dokumentasi/dok-neo2.png" class="img-fluid rounded img-dokum" alt="Dokumentasi UKM" />
                  <img src="dokumentasi/dok-neo2.png" class="img-fluid rounded img-dokum" alt="Dokumentasi UKM" />
                  <img src="dokumentasi/dok-neo2.png" class="img-fluid rounded img-dokum" alt="Dokumentasi UKM" />
              </div>

              <div class="col-md-6 dokum-head">
                  <h1>DOKUMENTASI</h1>
              </div>
              <!-- <div class="col-md-1">
  ...
  <section id="visimisi">
      <div class="container">
          <div class="row mb-5">
              <div class="col-md-6 visi-head align-middle">
                      ...
                      <div class="col">
                          ...
                          <div class="col">
                              <div class="card card-informasi border-light">
                                  <div class="card-body">
                                      <p class="card-text">
                                      <h4>Screenshot bukti follow instagram @neotelemetri</h4>
                                      </p>
                                  </div>
                              </div>
                              <!-- <div class="col">
