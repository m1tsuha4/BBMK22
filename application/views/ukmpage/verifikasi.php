...
$query = $this->db->query("SELECT * FROM peserta WHERE id_ukm = '$ss' AND stat_reg = '0' AND tahun = '2021' ");
?>
        ...
        <tbody>
            ...
            <?php
                if (isset($_POST["verify1$key->id"])) {
                    ...
                    if ($update) {
                        $this->alert->pesan("success", "Berhasil...", "Verifikasi berhasil  ", 1, base_url("/admin/verifikasi"));
                    } else {
                ...
                if (isset($_POST["unverify1$key->id"])) {
                    ...
                    if ($update) {
                        $this->alert->pesan("success", "Berhasil...", "Tidak Verifikasi berhasil  ", 1, base_url("/admin/verifikasi"));
                    } else {
                        $this->alert->pesan("error", "Gagal...");
                    }
                }
