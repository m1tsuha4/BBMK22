    ...
    <div class="login bg-2">
        ...
        <form class="form-group" action="" method="post">
            ...
            <div class="form-floating mb-3">
                ...
                <label for="floatingInput">NIMasd</label>
            </div>
            <div class="form-floating mb-3">
        ...
        <p class="h7 color-1 text-left">Belum punya akun? Daftar <a href="<?= base_url() ?>/main20/daftar">disini</a></p>
        <?php
            ...
            if ($query->num_rows() == 1) {
                ...
                if ($key->tahun == "") {
                    if (password_verify($password, $key->password)) {
                        ...
                        $this->alert->pesan("success", "Berhasil...", "Login berhasil...", 1, base_url("/main20/home"));
                    } else {
                        $this->alert->pesan("error", "Oops...", "Password salah...");
                    }
                } else {
                    $this->alert->pesan("error", "Oops...", "Anda Bukan Peserta Tahun Ini....");
                }
            } else {
