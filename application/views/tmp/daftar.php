...
<div class="container-lg">
	<div class="login daftar bg-2">
		...
		<form class="form-group" action="" method="post">
			<input type="hidden" <?= $keadaan ?> name="<?= $this->security->get_csrf_token_name(); ?>" value="<?= $this->security->get_csrf_hash(); ?>">
   
			<div class="form-floating mb-3">
				<input <?= $keadaan ?> type="text"  name="nama" class="form-control" id="floatingInput" placeholder="Username">
				<label for="floatingInput">Nama Panjang</label>
			</div>
			<div class="form-floating mb-3">
				<input  <?= $keadaan ?> type="number" name="nobp" class="form-control" id="floatingInput" placeholder="NIM">
				<label for="floatingInput">NIM</label>
			</div>
			<div class="form-floating mb-3">
				<input <?= $keadaan ?> type="password" name="password" class="form-control" id="floatingInput" placeholder="Password">
				<label for="floatingInput">Password</label>
			</div>
			<div class="form-floating mb-3">
				<input <?= $keadaan ?> type="password" name="password2" class="form-control" id="floatingInput" placeholder="Ulangi Password">
				<label for="floatingInput">Ulangi Password</label>
			</div>

				<label>Pilih UKM</label>
			<select <?= $keadaan ?> name="ukm" class="form-control">
				<?php
