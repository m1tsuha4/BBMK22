<div class="container-fluid">
	<nav class="navbar navbar-expand-sm navbar-light bg-light sticky-top">
		...
		<div id="peserta-navbar" class="collapse navbar-collapse">
			<ul class="navbar-nav">
				<li class="nav-item">
					<a class="nav-link text-primary" href="<?= base_url(); ?>main20/home">
			...
			<ul class="navbar-nav ml-auto">
				<li class="nav-item">
					<a class="nav-link text-danger" href="<?= base_url(); ?>main20/logout">
		...
		<div class="col-md-3">
			<ul class="list-group" style="background-color: #C4AECD;">
				...
				<li class="list-group-item" style="background-color: #C4AECD;">
					<i class="fas fa-home"></i>
					<a style="color: #3D005D" href="<?= base_url(); ?>main20/home">Dashboard</a>
				</li>
				<li class="list-group-item " style="background-color: #C4AECD;">
					<i class="fas fa-user"></i>
					<a style="color: #3D005D" href="<?= base_url(); ?>main20/home/profile">Profile</a>
				</li>
				<li class="list-group-item " style="background-color: #C4AECD;">
					<i class="fas fa-camera-retro"></i>
					<a style="color: #3D005D" href="<?= base_url(); ?>main20/home/foto">Upload Foto</a>
				</li>
				<li class="list-group-item " style="background-color: #C4AECD;">
					<i class="fas fa-id-card"></i>
					<a style="color: #3D005D" href="<?= base_url(); ?>main20/home/file">Upload File Verifikasi</a>
				</li>
				<!-- <li class="list-group-item " style="background-color: #C4AECD;">
					<i class="fas fa-id-card"></i>
				...
				<li class="list-group-item " style="background-color: #C4AECD;">
					...
					<a style="color: #3D005D" href="<?= base_url(); ?>main20/home/index/ukm">Info UKM</a>
				</li>
				<li class="list-group-item " style="background-color: #C4AECD;">
					<i class="fas fa-question-circle"></i>
					<a style="color: #3D005D" href="<?= base_url(); ?>main20/home/syarat">Syarat Daftar Ulang</a>
				</li>
				<li class="list-group-item " style="background-color: #C4AECD;">
					<i class="fas fa-clock"></i>
					<a style="color: #3D005D" href="<?= base_url(); ?>main20/home/jadwal">Jadwal dan Kegiatan BBMK</a>
				</li>
