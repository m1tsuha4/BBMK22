<ul class="list-group">
    ...
    <p class="mt-3">File materi maksimal 2Mb</p>
       <p class="mt-1">Gunakan (- atau _) untuk pengganti spasi. Ex : materi_1</p>
	</li>
	<li class="list-group-item">
		...
		if (isset($_POST["uploadfile"])) {
			...
			if ($size <= 2007200) {
				...
				$this->alert->pesan("error", "Gagal File melebihi 2 Mb...");
			}
		}
		// }
	...
	<li class="list-group-item">
		...
		foreach ($query2->result() as $data) { ?>
			...
			if (isset($_POST["hapus" . $data->id])) {
				...
				if ($delete) {
					$this->alert->pesan("success", "Materi berhasil dihapus", "", 1, base_url("/admin/home"));
				} else {
					$this->alert->pesan("error", "Gagal");
				}
			} ?>
