...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Peserta -->
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url() ?>superadmin/listpeserta">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url() ?>superadmin/stat">
            ...
            <!-- Nav Item - Statistik Peserta -->
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url() ?>superadmin/stat20">
                    <i class="far fa-chart-bar"></i>
            ...
            <!-- Nav Item - Input UKM -->
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url() ?>superadmin/inputukm">
            ...
            <!-- Nav Item - Lihat UKM -->
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url() ?>superadmin/lihatukm">
