                ...
                <div class="col-3">
                    ...
                    <div class="card info bg-3" style="width: 18rem;">
                        <div class="card-body">
                            ...
                            <a href="<?= base_url() ?>main20/ukm/<?= $ukm->username ?>" class="btn bg-1 color-4">Info Profile UKM</a>
                        </div>
                    </div>
                </div>
                <?php
        ...
        if (is_numeric($nobp)) {
            if (preg_match("/^19/", $nobp) or preg_match("/^20/", $nobp) or preg_match("/^18/", $nobp)) {
                ...
                if ($uquery->num_rows() == 1) {
                    $this->alert->pesan("success", "Selamat", "Akunmu telah terdaftar, silahkan login...", 1, base_url("/main20/login"));
                } else {
                    $this->alert->pesan("warning", "Oops...", "Akunmu belum terdaftar, silahkan mendaftar segera....", 1, base_url("/20/daftar"));
                }
            } else {
