...
<nav class="navbar navbar-expand-sm navbar-light bg-light sticky-top">
	...
	<div id="bbmk-navbar" class="collapse navbar-collapse">
		<ul class="navbar-nav">
			<li class="nav-item">
				<a class="nav-link text-primary" href="<?= base_url(); ?>admin/home">
			...
			<li class="nav-item">
				...
				<div id="profile-content" class="collapse" data-parent="#profile" style="position: absolute; width: 130px; right: 0">
					<ul class="list-group">
						...
						<li class="list-group-item text-right">
							<a href="<?= base_url(); ?>admin/setting" style="color: #3D005D">Pengaturan</a>
						</li>
						<li class="list-group-item text-right">
							<a href="<?= base_url(); ?>admin/logout" style="color: #3D005D">Logout</a>
						</li>
					</ul>
				</div>
			</li>
				...
				<div id="update-profile" class="collapse show" data-parent="#ukm">
					<ul class="list-group list-group-flush">
						...
						<li class="list-group-item" style="background-color: #C4AECD;">
							...
							<a href="<?= base_url(); ?>admin/edit" style="color: #3D005D">Edit Profile UKM</a>
						</li>
						<li class="list-group-item" style="background-color: #C4AECD;">
							<i class="fas fa-arrow-right"></i>
							<a href="<?= base_url(); ?>admin/timeline" style="color: #3D005D">Timeline</a>
						</li>
						<li class="list-group-item" style="background-color: #C4AECD;">
							<i class="fas fa-arrow-right"></i>
							<a href="<?= base_url(); ?>admin/sosial" style="color: #3D005D">Media Sosial</a>
						</li>
						<li class="list-group-item" style="background-color: #C4AECD;">
							<i class="fas fa-arrow-right"></i>
							<a href="<?= base_url(); ?>admin/notif" style="color: #3D005D">Buat Pemberitahuan</a>
						</li>
						<!-- <li class="list-group-item" style="background-color: #C4AECD;">
							<i class="fas fa-arrow-right"></i>
							<a href="<?= base_url(); ?>admin/cetak" style="color: #3D005D">Print List Peserta</a>
						</li> -->
						<li class="list-group-item" style="background-color: #C4AECD;">
							<i class="fas fa-arrow-right"></i>
							<a href="<?= base_url(); ?>admin/syarat" style="color: #3D005D">Syarat Daftar Ulang</a>
						</li>
						<!-- <li class="list-group-item" style="background-color: #C4AECD;">
							<i class="fas fa-arrow-right"></i>
							<a href="<?= base_url(); ?>admin/jadwal" style="color: #3D005D">Jadwal dan Kegiatan BBMK</a>
						</li> -->

						<!-- tambahan baru 2019 -->
						<li class="list-group-item" style="background-color: #C4AECD;">
							<i class="fas fa-arrow-right"></i>
							<a href="<?= base_url(); ?>admin/dokumentasi" style="color: #3D005D">Upload Materi</a>
						</li>
					</ul>
				</div>
			</li>
			<li class="list-group-item" id="peserta" style="background-color: #C4AECD;">
				...
				<div id="peserta-content" class="collapse show" data-parent="#peserta">
					<ul class="list-group list-group-flush">
						<li class="list-group-item" style="background-color: #C4AECD;">
							<i class="fas fa-arrow-right"></i>
							<a href="<?= base_url(); ?>admin/peserta" style="color: #3D005D">Semua</a>
						</li>
						<li class="list-group-item" style="background-color: #C4AECD;">
							<i class="fas fa-arrow-right"></i>
							<a href="<?= base_url(); ?>admin/peserta/belum" style="color: #3D005D">Belum Verifikasi</a>
						</li>
						<li class="list-group-item" style="background-color: #C4AECD;">
							<i class="fas fa-arrow-right"></i>
							<a href="<?= base_url(); ?>admin/peserta/sudah" style="color: #3D005D">Sudah Verifikasi</a>
						</li>
						<li class="list-group-item" style="background-color: #C4AECD;">
							<i class="fas fa-arrow-right"></i>
							<a href="<?= base_url(); ?>admin/kehadiran" style="color: #3D005D">Absensi Peserta</a>
						</li>
						<li class="list-group-item" style="background-color: #C4AECD;">
							<i class="fas fa-arrow-right"></i>
							<a href="<?= base_url(); ?>admin/daftarhadir" style="color: #3D005D">Daftar Kehadiran Peserta</a>
						</li>
						<li class="list-group-item" style="background-color: #C4AECD;">
							<i class="fas fa-arrow-right"></i>
							<a href="<?= base_url(); ?>admin/kelulusanpeserta" style="color: #3D005D">Kelulusan Peserta</a>
						</li>
					</ul>
				</div>
			</li>
