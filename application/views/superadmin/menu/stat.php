...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="<?= base_url() ?>superadmin/downloadpeserta" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Generate All Participant</a>
        <a href="<?= base_url() ?>superadmin/downloadukm" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Generate UKM</a>
        <a href="<?= base_url() ?>superadmin/downloadfakultas" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Generate Faculty</a>
        <a href="<?= base_url() ?>superadmin/downloadjurusan" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Generate Major</a>
    </div>
    ...
    <div class="row">
        ...
        foreach ($query->result() as $ukm) {
            ...
            $pesertaverif = $this->db->query("SELECT* FROM peserta WHERE id_ukm ='$ukm->id' AND stat_reg= 1 AND tahun ='2021'");
            $pesertanonverif = $this->db->query("SELECT* FROM peserta WHERE id_ukm ='$ukm->id' AND stat_reg= 2 AND tahun ='2021'");
            $pesertabelumverif = $this->db->query("SELECT* FROM peserta WHERE id_ukm ='$ukm->id' AND stat_reg= 0 AND tahun ='2021'");

            $pesertalulus = $this->db->query("SELECT* FROM peserta WHERE id_ukm ='$ukm->id' AND kelulusan= 1 AND tahun ='2021'");
            $pesertatidaklulus = $this->db->query("SELECT* FROM peserta WHERE id_ukm ='$ukm->id' AND kelulusan= 2 AND tahun ='2021'");
            $pesertabelumlulus = $this->db->query("SELECT* FROM peserta WHERE id_ukm ='$ukm->id' AND kelulusan= 0 AND tahun ='2021'");
        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                foreach ($query->result() as $ukm) {
                    ...
                    $pesertaverif = $this->db->query("SELECT* FROM peserta WHERE fakultas ='$ukm->id' AND stat_reg= 1 AND tahun ='2021'");
                    $pesertanonverif = $this->db->query("SELECT* FROM peserta WHERE fakultas ='$ukm->id' AND stat_reg= 2 AND tahun ='2021'");
                    $pesertabelumverif = $this->db->query("SELECT* FROM peserta WHERE fakultas ='$ukm->id' AND stat_reg= 0 AND tahun ='2021'");

                    $pesertalulus = $this->db->query("SELECT* FROM peserta WHERE fakultas ='$ukm->id' AND kelulusan= 1 AND tahun ='2021'");
                    $pesertatidaklulus = $this->db->query("SELECT* FROM peserta WHERE fakultas ='$ukm->id' AND kelulusan= 2 AND tahun ='2021'");
                    $pesertabelumlulus = $this->db->query("SELECT* FROM peserta WHERE fakultas ='$ukm->id' AND kelulusan= 0 AND tahun ='2021'");
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    foreach ($jquery->result() as $j) {
                        $peserta = $this->db->query("SELECT* FROM peserta WHERE jurusan ='$j->id' AND tahun ='2021'");
                        $pesertaverif = $this->db->query("SELECT* FROM peserta WHERE jurusan ='$j->id' AND stat_reg= 1 AND tahun ='2021'");
                        $pesertanonverif = $this->db->query("SELECT* FROM peserta WHERE jurusan ='$j->id' AND stat_reg= 2 AND tahun ='2021'");
                        $pesertabelumverif = $this->db->query("SELECT* FROM peserta WHERE jurusan ='$j->id' AND stat_reg= 0 AND tahun ='2021'");

                        $pesertalulus = $this->db->query("SELECT* FROM peserta WHERE jurusan ='$j->id' AND kelulusan= 1 AND tahun ='2021'");
                        $pesertatidaklulus = $this->db->query("SELECT* FROM peserta WHERE jurusan ='$j->id' AND kelulusan= 2 AND tahun ='2021'");
                        $pesertabelumlulus = $this->db->query("SELECT* FROM peserta WHERE jurusan ='$j->id' AND kelulusan= 0 AND tahun ='2021'");
