        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav nav-ul">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?= base_url() ?>main20/#about">ABOUT</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?= base_url() ?>main20/#alur">ALUR</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?= base_url() ?>main20/#savedate">TIMELINE</a>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            ?>
                                <li><a class="dropdown-item" href="<?= base_url() ?>main20/ukm/<?= $ukm->username ?>"><?= $ukm->nama ?> </a></li>
                            <?php
                            }
                            ?>
                        </ul>
                    ...
                    <li class="nav-item" id="AC">
                        <a class="nav-link" href="<?= base_url() ?>main20/#cekakun"">ACCOUNT CHECK</a>
                    </li>
                    <li class=" nav-item">
                            <a class="nav-link" href="<?= base_url() ?>main20/login">LOGIN</a>
                    </li>
                </ul>
            </div>
        </div>
