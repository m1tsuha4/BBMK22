...
class Superadmin extends CI_Controller
{
    ...
    public function news()
    {
        if (@$this->session->userdata("superadmin")) {
            ...
            $this->load->view('superadmin/template/header');
            $this->load->view('superadmin/template/sidebar');
            $this->load->view('superadmin/menu/pemberitahuan');
            $this->load->view('superadmin/template/footer');
        } else {
            $data["title"] = "Login Super User";
            $this->load->view("tmp/header", $data);
    ...
    public function home()
    {
        ...
        if (@$this->session->userdata("superadmin")) {
            $this->load->view('superadmin/template/header');
            $this->load->view('superadmin/template/sidebar');
            // $this->load->view('superadmin/menu/home');
            $this->load->view('superadmin/menu/dashboard');
    ...
    public function reset($id = '1910952034')
    {
        ...
        if (@$this->session->userdata("superadmin")) {
            ...
            $this->load->view('superadmin/template/header');
            $this->load->view('superadmin/template/sidebar');
            $this->load->view('superadmin/menu/reset', $data);
            $this->load->view('superadmin/template/footer');
        } else {
            $data["title"] = "Login Super User";
            $this->load->view("tmp/header", $data);
    ...
    public function index()
    {
        if (isset($_POST["login"])) {
            ...
            if ($query->num_rows() == 1) {
                ...
                if (password_verify($password, $key->password)) {
                    ...
                    $this->alert->pesan("Yes", "Berhasil...", "Login berhasil...", 1, base_url("/superadmin/home"));
                } else {
        ...
        if (@$this->session->userdata("superadmin")) {
            $this->alert->msg("success", "Anda sudah login...", "", 1, base_url("/superadmin/home"));
        } else {
    ...
    {
        session_destroy();
        $this->alert->msg("success", "Logout berhasil...", "", 1, base_url("/superadmin"));
    }
    ...
    public function lihatUKM()
    {
        if (
            ...
            $this->load->view('superadmin/template/header');
            $this->load->view('superadmin/template/sidebar');
            $this->load->view('superadmin/menu/lihatukm');
            $this->load->view('superadmin/template/footer');
        } else {
    ...
    public function peserta($tahun = 2020, $page = 1)
    {
        if (
            ...
            $this->load->view('superadmin/template/header');
            $this->load->view('superadmin/template/sidebar');
            $this->load->view('superadmin/menu/peserta', $data);
            $this->load->view('superadmin/template/footer');
        } else {
            $this->alert->msg("error", "Oops..", "Anda tidak memiliki izin untuk mengakses halaman ini", 1, base_url() . "/superadmin/list");
        }
    ...
    public function listpeserta($tahun = 2020, $page = 1)
    {
        if (
            ...
            $this->load->view('superadmin/template/header');
            $this->load->view('superadmin/template/sidebar');
            $this->load->view('superadmin/menu/listpeserta', $data);
            $this->load->view('superadmin/template/footer');
        } else {
            $this->alert->msg("error", "Oops..", "Anda tidak memiliki izin untuk mengakses halaman ini", 1, base_url() . "/superadmin/list");
        }
    ...
    public function stat()
    {
        if (
            ...
            $this->load->view('superadmin/template/header');
            $this->load->view('superadmin/template/sidebar');
            $this->load->view('superadmin/menu/stat');
            $this->load->view('superadmin/template/footer');
        } else {
            $this->alert->msg("error", "Oops..", "Anda tidak memiliki izin untuk mengakses halaman ini", 1, base_url() . "/superadmin/list");
        }
    ...
    public function stat20()
    {
        if (
            ...
            $this->load->view('superadmin/template/header');
            $this->load->view('superadmin/template/sidebar');
            $this->load->view('superadmin/menu/stat20');
            $this->load->view('superadmin/template/footer');
        } else {
            $this->alert->msg("error", "Oops..", "Anda tidak memiliki izin untuk mengakses halaman ini", 1, base_url() . "/superadmin/list");
        }
    ...
    public function find($id = '1910952034')
    {
        ...
        if (@$this->session->userdata("superadmin")) {
            ...
            $this->load->view('superadmin/template/header');
            $this->load->view('superadmin/template/sidebar');
            $this->load->view('superadmin/menu/find', $data);
            $this->load->view('superadmin/template/footer');
        } else {
            $data["title"] = "Login Super User";
            $this->load->view("tmp/header", $data);
    ...
    public function editUKM($id = null)
    {
        ...
        if (
            ...
            $this->load->view('superadmin/template/header');
            $this->load->view('superadmin/template/sidebar');
            $this->load->view('superadmin/menu/editukm', $data);
            $this->load->view('superadmin/template/footer');
        } else {
            $this->alert->msg("error", "Oops..", "Anda tidak memiliki izin untuk mengakses halaman ini", 1, base_url() . "/superadmin/list");
        }
    ...
    public function lihatdokumentasi()
    {
        if (
            ...
            $this->load->view('superadmin/template/header');
            $this->load->view('superadmin/template/sidebar');
            $this->load->view('superadmin/menu/dokumentasi');
            $this->load->view('superadmin/template/footer');
        } else {
            $this->alert->msg("error", "Oops..", "Anda tidak memiliki izin untuk mengakses halaman ini", 1, base_url() . "/superadmin/list");
        }
    ...
    public function setting()
    {
        ...
        if (@$this->session->userdata("superadmin")) {
            $this->load->view('superadmin/template/header');
            $this->load->view('superadmin/template/sidebar');
            $this->load->view('superadmin/menu/password');
            $this->load->view('superadmin/template/footer');
        } else {
            $this->alert->msg("error", "Oops..", "Anda tidak memiliki izin untuk mengakses halaman ini", 1, base_url() . "/superadmin/list");
        }
    ...
    public function statistik()
    {
        if (
            ...
            $this->load->view('superadmin/template/header');
            $this->load->view('superadmin/template/sidebar');
            $this->load->view('superadmin/menu/statistik');
            $this->load->view('superadmin/template/footer');
        } else {
            $this->alert->msg("error", "Oops..", "Anda tidak memiliki izin untuk mengakses halaman ini", 1, base_url() . "/superadmin/list");
        }
