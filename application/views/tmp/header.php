...
<head>
  ...
  <!-- Bootstrap core CSS -->
  <!-- <link href="<?= base_url(); ?>assets/tmp/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet"> -->
...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" href="<?= base_url(); ?>#page-top"><img src="<?= base_url(); ?>assets/img/logo3.png" height="30px"></a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="<?= base_url(); ?>#alur">Alur</a>
          </li>
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="<?= base_url(); ?>#timeline">Timeline</a>
          </li>
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="<?= base_url(); ?>#ukm">Ukm</a>
          </li>
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="<?= base_url(); ?>#cek">Account Check</a>
          </li>
          <li class="nav-item">
